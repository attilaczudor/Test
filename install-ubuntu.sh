...
echo "  repositories/clawx/                 — upstream desktop UI (Electron)"
echo "  repositories/ironclaw/              — Near AI agent infrastructure"
echo "  repositories/llama.cpp/             — GGUF inference engine"
echo "  repositories/awesome-openclaw-usecases/ — curated use cases"
echo "  repositories/nanobot/               — lightweight agent framework"
echo "  repositories/picoclaw/              — edge deployment"
echo "  repositories/zeroclaw/              — zero-shot agent framework"
echo "  repositories/artemis/               — ARTEMIS AI research framework (Stanford)"
divider
...
if [[ "$SKIP_OLLAMA" == "0" ]]; then
  ...
  echo "  llama.cpp: see repositories/llama.cpp/"
fi
...
echo "  repositories/clawx        → ValueCell-ai/ClawX (desktop UI)"
echo "  repositories/ironclaw     → nearai/ironclaw (agent infra)"
echo "  repositories/llama.cpp    → ggml-org/llama.cpp (inference)"
echo "  repositories/nanobot      → HKUDS/nanobot (lightweight agent)"
echo "  repositories/picoclaw     → sipeed/picoclaw (edge deploy)"
echo "  repositories/zeroclaw     → zeroclaw-labs/zeroclaw (zero-shot)"
echo "  repositories/artemis       → Stanford-Trinity/ARTEMIS (AI research)"
echo "  repositories/awesome-openclaw-usecases → anthropics/awesome-openclaw-usecases"
echo ""
