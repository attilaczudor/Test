 ...
 * @description Type definitions for agent command options, run context, and stream parameters.
 */
...
/** Stream parameter overrides for agent provider calls. */
...
/** Runtime context for an agent run, including channel, account, and group identifiers. */
...
/** Full set of options for invoking an agent command. */
