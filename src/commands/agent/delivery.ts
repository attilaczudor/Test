/**
 * @module commands/agent/delivery
 * @description Handles delivery of agent command results to outbound channels.
 */
...
/**
 * Delivers the result of an agent command to the appropriate outbound channel.
 * Resolves delivery targets, normalizes payloads, and handles best-effort delivery errors.
 * @param params - Delivery parameters including config, runtime, session, and payloads.
 * @returns The normalized payloads and run metadata.
 */
