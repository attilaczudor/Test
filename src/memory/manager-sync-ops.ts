  ...
  private seedEmbeddingCache(sourceDb: DatabaseSync): void {
    ...
    try {
      ...
      try {
        ...
        // Best-effort rollback; original error will be rethrown.
      }
      throw err;
    }
  }
  ...
  private async syncMemoryFiles(params: {
    ...
    for (const stale of staleRows) {
      ...
      try {
        ...
        // Vector table may not exist yet; safe to ignore.
      }
      ...
      if (this.fts.enabled && this.fts.available) {
        try {
          ...
          // FTS table may not be ready; safe to ignore.
        }
      }
    }
  }
  ...
  private async runSafeReindex(params: {
    ...
    try {
      ...
      try {
        ...
        // Best-effort close of temp db during reindex rollback.
      }
  ...
  private resetIndex() {
    ...
    if (this.fts.enabled && this.fts.available) {
      try {
        ...
        // FTS table may not exist; safe to ignore during reset.
      }
    }
    this.dropVectorTable();
    this.vector.dims = undefined;
