/**
 * @module gateway/auth
 * @description Resolves and authorizes gateway connections using multiple authentication
 * strategies (token, password, Tailscale, trusted-proxy) with rate-limit integration.
 */
