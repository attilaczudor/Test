...
export default defineConfig({
  ...
  test: {
    ...
    // When running with the full upstream setup, unstub env/globals for isolation.
    // Our custom tests use module-level vi.stubGlobal, so skip when no setup file.
    unstubEnvs: !!process.env.OPENCLAW_FULL_SETUP,
    unstubGlobals: !!process.env.OPENCLAW_FULL_SETUP,
    pool: "forks",
